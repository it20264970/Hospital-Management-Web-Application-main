...
onSubmit = (e) =>{
  ...
  axios.post("/room/save",data).then((res) =>{
    if(res.data.success){
      alert("New Patient Room Detals Insert Successfully!")
      this.setState(
        {
            patientName:"",
            patientNIC:"",
  ...
  render() {
    return( 
      ...
      <div className="col-md-8 mt-4 mv-auto">
        <center>
        <h1 className="h3 mb-3 font-weight-normal">Room Details</h1>
        </center>
        ...
        <form className="needs-validation" noValidate>
          ...
          <button className="btn btn-warning"  type="submit"
           style={{fontSize:'1.25rem' ,float: 'center' ,
           paddingLeft: '1.4rem',paddingRight: '2rem', margin: '0.5rem 0',border:'2px',
            borderRadius: '8px',color:'black', borderBlockColor:'black'}} onClick={this.onSubmit}>
